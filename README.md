...
* The link to the livecode is [here](https://github.com/ldnagel/spatial-r-for-gis-users/blob/master/scripts/maptime_workshop_code.R) that you can download or copy/paste the contents directly from your browser (although it may be slightly different from the livecode)
