...
* The link to the livecode is [here](); there's also a script [here](https://github.com/ldnagel/spatial-r-for-gis-users/blob/master/scripts/Spatial_R_workshop_code.R) that you can download or copy/paste directly from (although it may be slightly different from the livecode)
